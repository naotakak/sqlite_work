...
while True:
	try:
		period = input("Choose period 4,8 or 9 ")
		arrlength = len(CLASSES[period])
		break
	except:
		print("No such period, try again")
print("Here is your student: " + CLASSES[period][random.randint(0,arrlength)])
